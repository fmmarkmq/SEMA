...
python -m sema.cli.train_cli rollout \
    ...
    --output_file "qwen14b_prefilling_rollout.json"
...
accelerate launch --num_processes 8 \
    ...
    --model_name_or_path Qwen/Qwen2.5-14B-Instruct \
    --output_dir files/checkpoints/prefilling_self-tuned-Qwen2.5-14B-Instruct \
    --dataset_name json \
    --data_path "files/prefilling_rollouts/qwen14b_prefilling_rollout.json" \
    ...
    --report_to wandb \
    --run_name prefilling_self-tuning_qwen14b \
    --seed 42